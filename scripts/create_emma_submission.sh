...
data:
  ...
  eval_diar_cutsets:
    ...
    - ${oc.env:MANIFEST_DIR_DIAR}/librimix/librimix_cutset_libri2mix_test-clean_aligned_external_enrollment.jsonl.gz
    - ${oc.env:MANIFEST_DIR_DIAR}/librimix/librimix_cutset_libri2mix_test-clean_noisy_aligned_external_enrollment.jsonl.gz
    - ${oc.env:MANIFEST_DIR_DIAR}/librimix/librimix_cutset_libri3mix_test-clean_aligned_external_enrollment.jsonl.gz
    - ${oc.env:MANIFEST_DIR_DIAR}/librimix/librimix_cutset_libri3mix_test-clean_noisy_aligned_external_enrollment.jsonl.gz
    - ${oc.env:MANIFEST_DIR_DIAR}/librispeechmix/librispeechmix_cutset_test-clean-1mix_aligned_external_enrollment.jsonl.gz
    - ${oc.env:MANIFEST_DIR_DIAR}/librispeechmix/librispeechmix_cutset_test-clean-2mix_aligned_external_enrollment.jsonl.gz
    - ${oc.env:MANIFEST_DIR_DIAR}/librispeechmix/librispeechmix_cutset_test-clean-3mix_aligned_external_enrollment.jsonl.gz
  enrollment_cutsets:
