...
system_out_dir="/mnt/matylda5/ipoloka/challenges/NOTSOFAR1-Challenge/system1_sc_final"
mkdir -p $system_out_dir
mkdir -p $system_out_dir/dev
mkdir -p $system_out_dir/eval


dev_path="/mnt/matylda5/ipoloka/challenges/NOTSOFAR1-Challenge/outputs/decoding_large_v3_wo_timestamps_5k_v3/wer/singlechannel"
dev_tmp_dir="/mnt/matylda5/ipoloka/challenges/NOTSOFAR1-Challenge/system1_sc_final_tmp_dev"
mkdir -p $dev_tmp_dir
...
eval_path="/mnt/matylda5/ipoloka/challenges/NOTSOFAR1-Challenge/outputs/eval_decoding_v1.1/wer/singlechannel"
eval_tmp_dir="/mnt/matylda5/ipoloka/challenges/NOTSOFAR1-Challenge/system1_sc_final_tmp_eval"
...
# replace by cp
cp /mnt/matylda5/ipoloka/challenges/NOTSOFAR1-Challenge/sc_info.yaml  $system_out_dir/info.yaml
