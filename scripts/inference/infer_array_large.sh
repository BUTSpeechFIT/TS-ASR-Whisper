...
args=(
--output_dir "/mnt/matylda5/ipoloka/challenges/NOTSOFAR1-Challenge/outputs/decoding_large_ft_v2.1_att_only"
...
#--init_from="/mnt/scratch/tmp/ipoloka/experiments/Whisper_large_dev_FT_higher_lr/checkpoint-260"
