...
from models.dicow_w_diar.modeling_dicow import DiCoWForConditionalGeneration
...
class WhisperContainer:
    def __init__(self, use_flash_attention=False, params_to_keep_frozen_keywords=None, remove_timestamps_from_ctc=False,
        ...
        print(self.model.model.encoder.lang_encoder.load_state_dict(
            self.model.model.encoder.state_dict(),
            strict=False
        ))
