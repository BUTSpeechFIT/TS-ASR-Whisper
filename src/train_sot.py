...
from data.sot_dataset import SOT_Dataset, LhotseLongFormDataset, DataCollator
...
from utils.evaluation import compute_sot_longform_metrics
...
class ModelTrainer:
    ...
    def _create_compute_metrics_fn(self, dev_datasets):
        ...
        def _compute_metrics(pred, dset=None, split='dev', metrics_list=None):
            ...
            return compute_sot_longform_metrics(
